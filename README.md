...
<body class="bg-stone-50 text-stone-800">
    ...
    <section class="py-20 px-6 bg-stone-100 text-center">
        <div class="max-w-2xl mx-auto">
            ...
            <!-- LINE公式アカウントの友だち追加URLに修正 -->
            <a href="https://line.me/R/ti/p/@517ynoyv" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-3 bg-[#06C755] hover:bg-[#05b14c] text-white px-10 py-6 rounded-2xl transition duration-300 font-bold text-xl shadow-xl w-full max-w-md group">
